      	...
      	<FlippingCardBack>
					<div className="BackCard FrontCard BackProjectCard4">
						...
						<div style={{ backgroundColor: this.props.backgroundFlippingCardBack }} className="details">
							...
							<p style={{ color: this.props.textFlippingCardBack }} className="text-details">Site web permettant à différents utilisateurs de communiquer sous un pseudo qu'ils auront au préalablement indiqués sur la page de connexion.</p>
						</div>
					</div>
  	  	</FlippingCardBack>
    	</FlippingCard>
