      	...
      	<FlippingCardBack>
					<div className="BackCard FrontCard BackProjectCard5">
						...
						<div style={{ backgroundColor: this.props.backgroundFlippingCardBack }} className="details">
							...
							<p style={{ color: this.props.textFlippingCard }} className="text-details">Site web permettant à différents utilisateurs d’héberger leurs recettes et de les modifier grâce à un système d’authentification via un compte Google, Facebook ou Twitter.</p>
						</div>
					</div>
  	  	</FlippingCardBack>
    	</FlippingCard>
